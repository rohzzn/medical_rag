...
// Sample suggested questions focused on CEGIR research
const suggestedQuestions = [
  "What are the diagnostic criteria for eosinophilic esophagitis?",
  "How does CEGIR define eosinophilic esophagitis?",
  "What are the treatment options for eosinophilic gastrointestinal diseases?",
  "How does the pathophysiology of EoE differ from other eosinophilic disorders?",
  "What biomarkers are being studied by CEGIR for eosinophilic gastrointestinal diseases?",
  "What is the prevalence of eosinophilic esophagitis in pediatric patients?",
  "How do dietary interventions affect treatment outcomes in EoE?",
  "What are the latest CEGIR research findings on EoE?",
  "What genetic factors contribute to eosinophilic gastrointestinal diseases?"
];
...
export default function Chat() {
  ...
  return (
    <Layout title="Chat | CEGIR Literature Search Assistant">
